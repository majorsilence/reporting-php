 ...
 *
 * Unlike Report, this class does not accept a $dotnetPath argument.
 * $rdlCmdPath must point to the native AOT or self-contained executable
 * (e.g. RdlCmd on Linux/macOS, RdlCmd.exe on Windows) — no .NET runtime is required.
 *
 * Usage:
 *   require_once __DIR__ . '/../src/ReportAot.php';
...
class ReportAot
{
     ...
     * Binary formats (pdf, tif, tifb, rtf, xlsx) are returned as raw binary strings.
